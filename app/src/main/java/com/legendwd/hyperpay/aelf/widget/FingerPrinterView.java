...
public class FingerPrinterView extends View {
    ...
    private void initBitmap() {
        mFingerRed = ((BitmapDrawable) mResources.getDrawable(R.mipmap.finger_red)).getBitmap();
        mFingerGreen = ((BitmapDrawable) mResources.getDrawable(R.mipmap.finger_green)).getBitmap();
        mFingerGrey = ((BitmapDrawable) mResources.getDrawable(R.mipmap.finger_grey)).getBitmap();
