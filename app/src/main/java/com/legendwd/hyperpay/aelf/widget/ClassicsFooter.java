...
public class ClassicsFooter extends RelativeLayout implements RefreshFooter {
    ...
    private void initWord() {
        REFRESH_FOOTER_PULLUP = getContext().getString(R.string.footer_pull_up);
        REFRESH_FOOTER_RELEASE = getContext().getString(R.string.footer_release);
        REFRESH_FOOTER_LOADING = getContext().getString(R.string.footer_loading);
        REFRESH_FOOTER_REFRESHING = getContext().getString(R.string.footer_refreshing);
        REFRESH_FOOTER_FINISH = getContext().getString(R.string.footer_finish);
        REFRESH_FOOTER_FAILED = getContext().getString(R.string.footer_failed);
        REFRESH_FOOTER_ALLLOADED = getContext().getString(R.string.footer_all_loaded);
    }
