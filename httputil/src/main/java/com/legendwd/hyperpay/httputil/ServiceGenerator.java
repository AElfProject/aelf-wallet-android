...
public class ServiceGenerator {
    //    public static final String API_BASE_URL = "https://wallet-app-api-test.aelf.io/app/";   //线上环境
    public static String API_BASE_URL = "https://wallet-app-api-test.aelf.io/app/";//预发布环境
