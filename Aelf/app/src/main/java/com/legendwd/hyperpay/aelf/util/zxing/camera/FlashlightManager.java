...
final class FlashlightManager {
    ...
    static {
        ...
        if (iHardwareService == null) {
            Logger.e(TAG + "This device does supports control of a flashlight");
        } else {
            Logger.e(TAG + "This device does not support control of a flashlight");
        }
    }
    ...
    private static Class<?> maybeForName(String name) {
        try {
            ...
            Logger.e(TAG + "Unexpected error while finding class " + name + re);
            return null;
        }
    }
    ...
    private static Method maybeGetMethod(Class<?> clazz, String name, Class<?>... argClasses) {
        try {
            ...
            Logger.e(TAG + "Unexpected error while finding method " + name + re);
            return null;
        }
    }
    ...
    private static Object invoke(Method method, Object instance, Object... args) {
        try {
            ...
            Logger.e(TAG + "Unexpected error while invoking " + method + e);
            return null;
        } catch (InvocationTargetException e) {
            Logger.e(TAG + "Unexpected error while invoking " + method + e.getCause());
            return null;
        } catch (RuntimeException re) {
            Logger.e(TAG + "Unexpected error while invoking " + method + re);
            return null;
        }
    }
